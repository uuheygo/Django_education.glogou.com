...
def eda_vendor_data_collection():
    ...
    #with japaness
    input_file_name  ='output/eda_companies/eda_companies_with_japanese_utf8.txt'
    output_file_name ='output/eda_companies/eda_companies_with_japanese_out_pcb_utf8.txt'
    product_name ='pcb'
...
def csu_mba_data_collection():
    ...
    # no japanese
    input_file_name  ='output/csu/csu_school_utf8.txt'
    output_file_name ='output/csu/csu_school_out_mba.txt'

    #with japanese
    input_file_name  ='output/csu/csu_with_japanese_utf8.txt'
    output_file_name ='output/csu/csu_with_japanese_out_mba_utf8.txt'
    product_name ='mba'
...
def destination_site_data_collection():
    ...
    #with japanese
    input_file_name  ='output/travel_destination/travel_destination_with_Japanese_utf8.txt'
    output_file_name ='output/travel_destination/travel_destination_with_Japanese_out_travel_utf8.txt'
    product_name ='travel'
...
def earphone_vendor_data_collection():
    ...
    #no japanese
    input_file_name  ='output/earphone/earphone_vendors_utf8.txt'
    output_file_name ='output/earphone/earphone_vendors_out_earphone_utf8.txt'

    product_name ='earphone'

    Index_Search_All(input_file_name,  product_name, output_file_name )

def startup_schools_data_collection():

    #no japanese
    input_file_name  ='output/draper_univ/draper_university_with_Japanese_utf8.txt'
    output_file_name ='output/draper_univ/draper_university_with_Japanese_startup_utf8.txt'
...
if __name__ == "__main__":
    ...
    startup_schools_data_collection()
